            ...
            <div className="flex-1 flex items-center justify-center p-4 py-8 sm:py-12 relative z-10 overflow-y-auto">
                <div className="w-full max-w-md space-y-8 animate-fade-in">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-muted-foreground text-sm">Sign in to access your analysis dashboard</p>
                    </div>
                    ...
                    <div className="bg-[#111827]/50 border border-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm shadow-xl">
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-muted-foreground">
                                ...
                                <Link to="/signup" className="text-emerald-500 hover:text-emerald-400 font-medium hover:underline transition-all">
                                    Sign Up
                                </Link>
                            </p>
                        </div>
